...
{
	public class deviceinstalationtransactionpr
	{
		public List<Data> _data = new List<Data>();
		public State _error = new State();

		public deviceinstalationtransactionpr(State error, List<Data> data)
		{
			_error = error;
			_data = data;
		}
		public deviceinstalationtransactionpr(State error)
		{
			_error = error;
			_data = null;
		}
