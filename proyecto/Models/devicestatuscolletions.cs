...
{
	public class devicestatuscolletions
	{
		public List<Data> _data = new List<Data>();
		public State _error = new State();

		public devicestatuscolletions(State error, List<Data> data)
		{
			_error = error;
			_data = data;
		}
		public devicestatuscolletions(State error)
		{
			_error = error;
			_data = null;
		}
		public class Data
		{
			...
			public System.String carddispensercount{ get; set; }
		}
		public class State
		{
