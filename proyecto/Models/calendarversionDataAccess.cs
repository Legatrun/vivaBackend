	...
	public class calendarversionDataAccess
	{
		...
		public calendarversion Consultarcalendarversion()
		{
			...
			try
			{
				...
				SqlCommand SqlCmd = new SqlCommand("Proc_calendarversion_Select", SqlCnn);
		...
		public calendarversion Buscarcalendarversion(calendarversion.Data _calendarversionData)
		{
			...
			try
			{
				...
				SqlConnection SqlCnn;
				SqlCnn = Base.AbrirConexion();
				SqlCommand SqlCmd = new SqlCommand("Proc_calendarversion_Search", SqlCnn);
				SqlCmd.CommandType = CommandType.StoredProcedure;
		...
		public calendarversion.State Insertarcalendarversion(calendarversion.Data _calendarversion)
		{
			try
			{
				...
				SqlConnection SqlCnn;
				SqlCnn = Base.AbrirConexion();
				SqlCommand SqlCmd = new SqlCommand("Proc_calendarversion_Insert", SqlCnn);
				SqlCmd.CommandType = CommandType.StoredProcedure;
				...
				SqlCmd.Parameters.AddWithValue("@createtimestamp", _calendarversion.createtimestamp);
				SqlCmd.Parameters.AddWithValue("@updatetimestamp", _calendarversion.updatetimestamp);
				SqlCmd.Parameters.AddWithValue("@createuser", _calendarversion.createuser);
				SqlCmd.Parameters.AddWithValue("@updateuser", _calendarversion.updateuser);
		...
		public calendarversion.State Actualizarcalendarversion(calendarversion.Data _calendarversion)
		{
			try
			{
				...
				SqlConnection SqlCnn;
				SqlCnn = Base.AbrirConexion();
				SqlCommand SqlCmd = new SqlCommand("Proc_calendarversion_Update", SqlCnn);
				SqlCmd.CommandType = CommandType.StoredProcedure;
				SqlCmd.Parameters.AddWithValue("@id", _calendarversion.id);
				SqlCmd.Parameters.AddWithValue("@description", _calendarversion.description);
				SqlCmd.Parameters.AddWithValue("@validfrom", _calendarversion.validfrom);
		...
		public calendarversion.State Eliminarcalendarversion(calendarversion.Data _calendarversion)
		{
			try
			{
				...
				SqlConnection SqlCnn;
				SqlCnn = Base.AbrirConexion();
				SqlCommand SqlCmd = new SqlCommand("Proc_calendarversion_Delete", SqlCnn);
				SqlCmd.CommandType = CommandType.StoredProcedure;
				SqlCmd.Parameters.AddWithValue("@id", _calendarversion.id);
